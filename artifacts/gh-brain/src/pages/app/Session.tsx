...
function buildMarkdown(state: ReturnType<typeof useBrainSession>["state"]): string {
  return [
    ...
    ``,
    `---`,
    `*Generated by AI Brain — Don't just ask AI. Put the question on trial.*`,
  ].filter(Boolean).join("\n");
}
...
<head>
  <meta charset="utf-8" />
  <title>AI Brain Session — ${state.question.slice(0, 60)}</title>
  <style>
...
<body>
  ...
  <p style="margin-top:2rem;color:#999;font-size:0.75rem;">Generated by AI Brain — Don't just ask AI. Put the question on trial.</p>
</body>
</html>`;
                        ...
                        <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-6">
                          ...
                          <div className="p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                            <p className="text-xs text-muted-foreground">
                              ...
                              AI Brain provides AI-generated reasoning and decision support. It is not legal, medical, financial, or professional advice. Always verify important decisions with qualified professionals.
                            </p>
                          </div>
                        </div>
                      </TabsContent>
