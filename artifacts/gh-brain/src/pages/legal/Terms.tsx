            ...
            <div className="row">
              <div className="layout__split-2-1">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-red-200/80 leading-relaxed">
                          Litigant AI is an <strong>entertainment and exploratory reasoning tool</strong>. All outputs are produced by AI models and provided <strong>solely for entertainment, curiosity, and exploratory thinking</strong>. Nothing here constitutes legal, financial, or professional advice of any kind.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="hero-img-col">
                  <img
                    src="/terms-hero.png"
                    alt="Terms of service agreement"
