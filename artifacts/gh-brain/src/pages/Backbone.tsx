    ...
    <>
        ...
        <div className="row">
          ...
          <div style={{
            ...
            <div><span style={{ color: "hsl(var(--primary))" }}>&lt;body</span> <span style={{ color: "hsl(38 92% 50%)" }}>class="stage"</span><span style={{ color: "hsl(var(--primary))" }}>&gt;</span> <span style={{ color: "hsl(var(--muted-foreground))" }}>← universal surface · base bg · flex-col · NO extra wrapper needed</span></div>
            ...
            <div style={{ paddingLeft: "3rem" }}><span style={{ color: "hsl(var(--primary))" }}>&lt;header&gt;</span> <span style={{ color: "hsl(var(--muted-foreground))" }}>← injected by AppLayout · sticky · full width · natural height</span></div>
