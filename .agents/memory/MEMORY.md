...
- [Provider failover](provider-failover.md) — silent whole-session swap on ProviderFailureError; callRole+triggerFailover in brainEngine; client pins backup via failoverProvider field.
